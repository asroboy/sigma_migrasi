...
arcpy.MakeFeatureLayer_management('ADMINISTRASI_AR_INTERSECT_POINT_shp', Layer_Point, "", "",
                                  "FID FID VISIBLE NONE;FID_ADMINI FID_ADMINI VISIBLE NONE;Shape Shape VISIBLE NONE;WADMKC WADMKC VISIBLE NONE;KDBBPS KDBBPS VISIBLE NONE;WADMKD WADMKD VISIBLE NONE;KDEPUM KDEPUM VISIBLE NONE;KDCPUM KDCPUM VISIBLE NONE;FCODE FCODE VISIBLE NONE;WIADKK WIADKK VISIBLE NONE;SHAPE_AREA SHAPE_AREA VISIBLE NONE;NAMOBJ NAMOBJ VISIBLE NONE;OBJECTID OBJECTID VISIBLE NONE;KDPBPS KDPBPS VISIBLE NONE;SHAPE_LENG SHAPE_LENG VISIBLE NONE;WIADKC WIADKC VISIBLE NONE;WIADKD WIADKD VISIBLE NONE;WADMKK WADMKK VISIBLE NONE;REMARK REMARK VISIBLE NONE;KDCBPS KDCBPS VISIBLE NONE;KDEBPS KDEBPS VISIBLE NONE;KDPKAB KDPKAB VISIBLE NONE;SRS_ID SRS_ID VISIBLE NONE;KDPPUM KDPPUM VISIBLE NONE;TIPADM TIPADM VISIBLE NONE;WIADPR WIADPR VISIBLE NONE;LUASWH LUASWH VISIBLE NONE;LCODE LCODE VISIBLE NONE;METADATA METADATA VISIBLE NONE;WADMPR WADMPR VISIBLE NONE;FID_INDEKS FID_INDEKS VISIBLE NONE;Id Id VISIBLE NONE;REGION REGION VISIBLE NONE;NOMOR_PETA NOMOR_PETA VISIBLE NONE;NAMA_PETA NAMA_PETA VISIBLE NONE;THN_BUAT_1 THN_BUAT_1 VISIBLE NONE;NAMA_PEK_1 NAMA_PEK_1 VISIBLE NONE;PELAKSAN_1 PELAKSAN_1 VISIBLE NONE;ORIG_FID ORIG_FID VISIBLE NONE")
#
#
