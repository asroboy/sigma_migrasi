...
unsurName = str(sys.argv[4])
# env.workspace = "C:\Users\Ridho\AppData\Roaming\Esri\Desktop10.2\ArcCatalog\MIGRASISDE@LOCAL.sde"
env.workspace = conPath

Source_ = folderName + "\\" + skemaName + ".sde" + "\\" + skemaName + "." + unsurName

# SHAPE FILE DIGANTI DENGAN TABLE UNSUR SDE
Target_ = folderName + "\\" + skemaName + ".sde" + "\\" + skemaName + "." + unsurName + "_TMP"

arcpy.CopyFeatures_management(Source_, Target_)

# arcpy.FeatureClassToShapefile_conversion([skemaName + "." + unsurName],
#                                          "C:\\migrasi\\tmp\\publikasi")
