 ...
 * @author wallet
 */
public class MdMaintenanceInfo implements java.io.Serializable{
    ...
    public MdMaintenanceInfo() {
    }

    public MdMaintenanceInfo(BigDecimal id) {
        this.id = id;
    }

    public MdMaintenanceInfo(BigDecimal id, Date dateOfNextUpdate, String userDefinedMaintenanceFreq, BigDecimal mdIdentificationId, String maintenanceAndUpdateFrequency, BigDecimal mdMetadataId) {
        this.id = id;
